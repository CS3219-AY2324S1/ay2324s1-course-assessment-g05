...
const getUserByEmail = async (
    ...
    return throwAndLogError("getUserByEmail", response.message, getError(response.status));
};
...
const getUserById = async (id: string, cache: RequestCache = "no-cache"): Promise<User> => {
    ...
    return throwAndLogError("getUserById", response.message, getError(response.status));
};
...
const createUser = async (user: User, cache: RequestCache = "no-cache") => {
    ...
    return throwAndLogError("createUser", response.message, getError(response.status));
};
...
const updateUser = async (id: string, user: User) => {
    ...
    return throwAndLogError("updateUser", response.message, getError(response.status));
};
...
const deleteUser = async (id: string) => {
    ...
    return throwAndLogError("deleteUser", response.message, getError(response.status));
};
...
const getUserPreferenceById = async (id: string) => {
    ...
    return throwAndLogError("getUserPreferenceById", response.message, getError(response.status));
};
...
const updateUserPreference = async (
    ...
    return throwAndLogError("updateUserPreference", response.message, getError(response.status));
};
